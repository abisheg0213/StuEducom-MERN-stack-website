...
export default function Staffentry(){
    ...
    return (
      ...
      <option>Computer Networks</option><option>Network tool and Technique</option><option>Operating Systems</option><option>FCC Laboratory</option><option>Python Programming with web framework</option><option>Compter Network Laboratory</option><option>SOFT SKILLS - II</option></select>} <br/><label> Marks :</label>
        <input onChange={(e)=>{
        ...
        <button onClick={(e)=>{
          ...
          {s==="24" ? axios.post('http://localhost:5000/addinternals/sem7',{rno:regnum,marks:markobt,subject:subname}) : axios.post('http://localhost:5000/addinternals/sem5',{rno:regnum,marks:markobt,subject:subname})}
